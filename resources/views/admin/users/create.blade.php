            ...
            <div class="card">
                ...
                <form class="form-horizontal" action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="inputPhone3" class="col-sm-2 control-label">شماره تلفن</label>
                            <input type="tel" name="phoneNumber" class="form-control" id="inputPhone3" placeholder="شماره تلفن را وارد کنید" >
                        </div>
                        <div class="form-group">
